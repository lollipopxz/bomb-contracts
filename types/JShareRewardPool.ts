...
export interface JShareRewardPoolInterface extends utils.Interface {
  functions: {
...
export interface JShareRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: JShareRewardPoolInterface;

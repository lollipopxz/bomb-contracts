...
export interface JiraInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "INITIAL_JIRA_POOL_DISTRIBUTION",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Jira extends BaseContract {
  ...
  functions: {
    ...
    INITIAL_JIRA_POOL_DISTRIBUTION(
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  INITIAL_JIRA_POOL_DISTRIBUTION(overrides?: CallOverrides): Promise<BigNumber>;
